namespace ChakraBridge
{
    ...
    public struct JavaScriptValue
    {
        ...
        internal JavaScriptValueType ValueType
        {
            get
            {
        ...
        ///     Requires an active script context.
        /// </remarks>
        internal bool IsExtensionAllowed
        {
            get
            {
                bool allowed;
        ...
        internal static JavaScriptValue FromObject(object value)
        {
            JavaScriptValue reference;
        ...
        internal static JavaScriptValue CreateObject()
        {
            JavaScriptValue reference;
        ...
        /// </param>
        /// <returns>The new <c>Object</c>.</returns>
        internal static JavaScriptValue CreateExternalObject(IntPtr data, JavaScriptObjectFinalizeCallback finalizer)
        {
            JavaScriptValue reference;
        ...
        /// <returns>The new function object.</returns>
        internal static JavaScriptValue CreateFunction(JavaScriptNativeFunction function, IntPtr callbackData)
        {
            JavaScriptValue reference;
        ...
        internal static JavaScriptValue CreateArray(uint length)
        {
            JavaScriptValue reference;
        ...
        internal static JavaScriptValue CreateError(JavaScriptValue message)
        {
            JavaScriptValue reference;
        ...
        /// <param name="message">Message for the error object.</param>
        /// <returns>The new error object.</returns>
        internal static JavaScriptValue CreateRangeError(JavaScriptValue message)
        {
            JavaScriptValue reference;
        ...
        /// <param name="message">Message for the error object.</param>
        /// <returns>The new error object.</returns>
        internal static JavaScriptValue CreateReferenceError(JavaScriptValue message)
        {
            JavaScriptValue reference;
        ...
        /// <param name="message">Message for the error object.</param>
        /// <returns>The new error object.</returns>
        internal static JavaScriptValue CreateSyntaxError(JavaScriptValue message)
        {
            JavaScriptValue reference;
        ...
        /// <param name="message">Message for the error object.</param>
        /// <returns>The new error object.</returns>
        internal static JavaScriptValue CreateTypeError(JavaScriptValue message)
        {
            JavaScriptValue reference;
        ...
        /// <param name="message">Message for the error object.</param>
        /// <returns>The new error object.</returns>
        internal static JavaScriptValue CreateUriError(JavaScriptValue message)
        {
            JavaScriptValue reference;
        ...
        ///     Requires an active script context.
        /// </remarks>
        internal void PreventExtension()
        {
        ...
        internal JavaScriptValue GetOwnPropertyDescriptor(JavaScriptPropertyId propertyId)
        {
        ...
        internal JavaScriptValue GetOwnPropertyNames()
        {
        ...
        internal bool HasProperty(JavaScriptPropertyId propertyId)
        {
            bool hasProperty;
        ...
        internal JavaScriptValue GetProperty(JavaScriptPropertyId id)
        {
        ...
        internal void SetProperty(JavaScriptPropertyId id, JavaScriptValue value, bool useStrictRules)
        {
        ...
        internal JavaScriptValue DeleteProperty(JavaScriptPropertyId propertyId, bool useStrictRules)
        {
        ...
        internal bool DefineProperty(JavaScriptPropertyId propertyId, JavaScriptValue propertyDescriptor)
        {
            bool result;
        ...
        internal bool HasIndexedProperty(JavaScriptValue index)
        {
            bool hasProperty;
        ...
        internal JavaScriptValue GetIndexedProperty(JavaScriptValue index)
        {
            JavaScriptValue propertyReference;
        ...
        internal void SetIndexedProperty(JavaScriptValue index, JavaScriptValue value)
        {
        ...
        internal void DeleteIndexedProperty(JavaScriptValue index)
        {
        ...
        internal bool StrictEquals(JavaScriptValue other)
        {
            bool equals;
        ...
        internal JavaScriptValue ConstructObject(params JavaScriptValue[] arguments)
        {
            JavaScriptValue returnReference;
